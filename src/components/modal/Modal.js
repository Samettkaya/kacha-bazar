                      ...
                      <div className="w-full flex flex-col p-5 md:p-8 text-left">
                        <div className="mb-2 md:mb-2.5 block -mt-1.5">
                          <h1
                            ...
                            href="/product/organic-bell-pepper"
                          >
                            {data.title}
                          </h1>
                          {data.stock === 0 ? (
                        ...
                        <div className="flex flex-col mt-4">
                         ...
                         {data.tag.map(tag=>   <span className="bg-gray-50 mr-2 border-0 text-gray-600 rounded-full inline-flex items-center justify-center px-3 py-1 text-xs font-semibold  mt-2">
                           {tag.name}
                            </span>)}
