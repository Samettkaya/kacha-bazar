      ...
      <div onClick={openModal} className="relative flex justify-center w-full cursor-pointer">
        ...
        >
          ...
          <img
            ...
            style={{inset: "0px", boxSizing:" border-box", padding: "0px", border: "none" ,margin: "auto", display:" block", width: "160px", height: "160px", minWidth: "100%", maxWidth: "100%", minHeight: "100%", maxHeight:" 100%"}}
          />
        </span>
      </div>
