  ...
  return (
    <div className="w-full grid grid-col gap-4 grid-cols-1 2xl:gap-6 xl:grid-cols-3 md:grid-cols-2">
      {CategoriesData.map((categoryCard,index)=>{
       return (
        <div key={index} className=" rounded-lg mx-auto w-full relative  overlow-hidden transition ease-out duration-400 delay-150 transform hover:shadow-xl">
        <Link className="block" to={"/search?Category="+categoryCard.path}>
          <span
            style={{
          ...
          <div className="absolute top-0 left-0 z-10 p-r-16 flex-col flex w-full text-center justify-center">
            <div className="pt-4">
              ...
              <p className="text-sm  text-gray-50">Weekend discount offer</p>
