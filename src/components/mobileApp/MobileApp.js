    ...
    <div className="bg-indigo-50 py-10 lg:py-16 bg-repeat bg-center overflow-hidden">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-2 md:gap-3 lg:gap-3 items-center">
          ...
          <h3 className="text-xl md:text-2xl lg:text-3xl font-bold  mb-3">Get Your Daily Needs From Our KachaBazar Store</h3>
          ...
          <div className="mt-8 block lg:flex">
              <a className="mx-2" target="_blank" href="https://www.apple.com/app-store/">
              <span
              style={{
                boxSizing: "border-box",
                display: "inline-block",
            ...
            >
              ...
              <a className="mx-2" target="_blank" href="https://play.google.com/store/apps">
              <span
              style={{
                boxSizing: "border-box",
                display: "inline-block",
